...
def infer_column_mapping_fallback(columns: list[str]) -> dict:
    """Simple no-AI fallback: lowercase + underscore normalization."""
    result = {}
    for col in columns:
        ...
        result[col] = {
            ...
            "reasoning": "Fallback: no OpenAI key configured",
        }
    return result
