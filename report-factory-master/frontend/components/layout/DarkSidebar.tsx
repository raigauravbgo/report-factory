...
export default function DarkSidebar() {
  ...
  return (
    <aside className="flex h-screen w-[220px] flex-shrink-0 flex-col bg-[#1B2340]">
      {/* Logo */}
      <div className="flex items-center gap-3 px-5 py-5">
        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#00B5AD]">
          <span className="text-xs font-bold text-white">BGO</span>
        </div>
        <div>
          <p className="text-sm font-semibold leading-tight text-white">Bill Gosling</p>
          <p className="text-[10px] text-white/50">Executive Dashboard</p>
        </div>
      </div>
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors ${
                active
                  ? "bg-white/10 text-white border-l-2 border-[#00B5AD] pl-[10px]"
                  : "text-white/60 hover:bg-white/5 hover:text-white/90"
              }`}
            >
              <span className={active ? "text-[#00B5AD]" : ""}>{item.icon}</span>
      ...
      <div className="px-4 pb-5">
        <div className="flex items-center gap-3">
          <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#00B5AD] text-xs font-bold text-white">
            NB
          </div>
          <div className="min-w-0">
            <p className="truncate text-xs font-medium text-white">Nida Bijapure</p>
            <p className="truncate text-[10px] text-white/40">nida.bijapure@billgosling.com</p>
          </div>
        </div>
      </div>
    </aside>
